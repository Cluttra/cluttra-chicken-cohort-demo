...
export default function Home(){
  ...
  return <main>
    <header className="topbar"><a className="brand" href="#top"><span className="brandmark">C</span><span>Cluttra LLC<br/><b>Demo</b></span></a><div className="live"><i/> Tervezési demó</div><button className="export" onClick={downloadCsv}>Heti terv exportálása <span>↓</span></button></header>
